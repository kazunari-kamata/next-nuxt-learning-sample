...
AI エージェントに同じ構成・品質ゲートのプロジェクトを構築させる場合は、リポジトリの [AGENTS.md](AGENTS.md) と [再構築 skill](.agents/skills/next-nuxt-learning-sample/SKILL.md) を指示として渡してください。機能・構成・CI の具体的な基準は [blueprint](.agents/skills/next-nuxt-learning-sample/references/project-blueprint.md) にまとめています。
